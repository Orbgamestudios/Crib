...
// match, then made ~15% harder all round. The round multiplier grows
...
const HARDER = 1.15;        // 15% harder all around
...
export class Game {
  ...
  constructor(seats, hooks) {
    ...
    if (this.solo) this.botTimer = setInterval(() => this.botTick(), FAST ? 25 : 1800);
    this.round = 0;
    this.dealNumber = 0;
    this.dealerSeat = -1;
    this.phase = 'idle';
