...
export class Game {
  ...
  blindFor(p) { return this.mode === 'board' ? 0 : this.blind * (this.deckIs(p, 'neon') ? 2 : 1); }
  ...
  stateFor(playerId) {
    ...
    return {
      ...
      you: me ? {
        ...
        blindsPassed: me.blindsPassed, blind: this.blindFor(me), dealMult: BASE_MULT + me.dealPegMult, cosmicHandBonus: me.cosmicHandBonus || 0,
