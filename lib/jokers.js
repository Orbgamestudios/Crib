...
export const JOKERS = [
  ...
  // pegging
  { id: 'counter_king', name: 'Counter King', desc: 'When your play leaves the count above 15, gain +1 Mult for each count above 15.', cost: 6, mods: {} },
  ...
  { id: 'crib_battery', name: 'Crib Battery', desc: 'Your crib Mult is multiplied by ×1.25 for each unique suit in the crib.', cost: 7, mods: { cribSuitMult: 1.25 } },
  ...
  { id: 'card_smith', name: 'Card Smith', desc: 'Open a free Standard Pack (add a card to your deck) every time you reach the shop.', cost: 6, mods: { freeStandardPack: 1 } },
