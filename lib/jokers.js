...
export const JOKERS = [
  ...
  { id: 'overseer', name: 'The Overseer', desc: 'Passive: add +4 Hand Points whenever your regular hand scores. This does not affect your crib.', cost: 6, mods: { handFlat: 4 } },
  ...
  { id: 'jack_of_all', name: 'Jack of All', desc: 'Passive: when your regular hand scores, each Jack in that hand adds +2 Hand Points.', cost: 3, mods: { rankBonus: { ranks: [11], pts: 2 } } },
  { id: 'even_steven', name: 'Even Steven', desc: 'Passive: when your regular hand scores, each 2, 4, 6, 8, or 10 in that hand adds +1 Hand Point.', cost: 4, mods: { rankBonus: { ranks: [2, 4, 6, 8, 10], pts: 1 } } },
  { id: 'odd_todd', name: 'Odd Todd', desc: 'Passive: when your regular hand scores, each Ace, 3, 5, 7, or 9 in that hand adds +1 Hand Point.', cost: 4, mods: { rankBonus: { ranks: [1, 3, 5, 7, 9], pts: 1 } } },
  ...
  { id: 'scary_face', name: 'Scary Face', desc: 'Passive: when your regular hand scores, each Jack, Queen, or King in that hand adds +2 Hand Points.', cost: 4, mods: { rankBonus: { ranks: [11, 12, 13], pts: 2 } } },
  { id: 'greedy_joker', name: 'Greedy Joker', desc: 'Passive: when your regular hand scores, each Diamond in that hand adds +1 Hand Point.', cost: 4, mods: { suitBonus: { suit: 1, pts: 1 } } },
  { id: 'lusty_joker', name: 'Lusty Joker', desc: 'Passive: when your regular hand scores, each Heart in that hand adds +1 Hand Point.', cost: 4, mods: { suitBonus: { suit: 0, pts: 1 } } },
  { id: 'gluttonous_joker', name: 'Gluttonous Joker', desc: 'Passive: when your regular hand scores, each Club in that hand adds +1 Hand Point.', cost: 4, mods: { suitBonus: { suit: 2, pts: 1 } } },
  { id: 'wrathful_joker', name: 'Wrathful Joker', desc: 'Passive: when your regular hand scores, each Spade in that hand adds +1 Hand Point.', cost: 4, mods: { suitBonus: { suit: 3, pts: 1 } } },
  ...
  { id: 'his_majesty', name: 'His Majesty', desc: 'Passive: when the starter card is a Jack, Queen, or King, add +4 Hand Points to your regular hand.', cost: 4, mods: { starterFace: 4 } },
  { id: 'bull_market', name: 'Bull Market', desc: 'Passive: when your regular hand scores, add +1 Hand Point for every 4 coins you currently hold.', cost: 5, mods: { bull: 1 } },
  ...
  { id: 'obelisk', name: 'Obelisk', desc: 'Passive: add +8 Hand Points whenever your regular hand scores. This does not affect your crib.', cost: 8, mods: { handFlat: 8 } },
